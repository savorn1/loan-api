...
// still reach unannotated endpoints; @PreAuthorize on the mutating endpoints (posting, closing
// periods, editing the chart of accounts) is what actually enforces the ADMIN role.
@Configuration
@EnableWebSecurity
